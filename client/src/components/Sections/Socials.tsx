...
const Socials = () => {
  return (
    <div className="bg-[#102C57]">
      <div className=" flex justify-center flex-col rounded-[70px] md:rounded-[100px] p-[50px] xsm:p-[70px] md:p-[100px]">
        <h1 className=" mx-auto mb-5 text-white font-bold">Connect with us!</h1>
