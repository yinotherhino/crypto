...
const Long = ({ extraStyle, children }: { children: React.ReactNode; extraStyle?: string }) => {
   return (
      <div
         className={twMerge(
...
const Deposit = ({
   ...
   return (
      <div
         className={twMerge(
            ` mb-[50px] py-5 px-10 flex flex-col justify-between w-full xsm:mb-0 hover:2sm rounded-lg bg-black text-white `,
            extraStyle
         )}>
         <div className="flex justify-between">
            ...
            <div>
            <p>
               <h5 className={twMerge("mb-2 text-2xl font-bold tracking-tight text-white ")}>{header}</h5>
            </p>
